...
List<List<Search>> searchFromJson(String str) => List<List<Search>>.from(json
    .decode(str)
    .map((x) => List<Search>.from(x.map((x) => Search.fromJson(x)))));

String searchToJson(List<List<Search>> data) => json.encode(List<dynamic>.from(
...
class Calendar {
  ...
  factory Calendar.fromJson(Map<String, dynamic> json) => Calendar(
        ...
        detail:
            json["detail"] == null ? null : detailValues.map![json["detail"]],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "is_active": isActive,
        "box_count": boxCount,
        "detail": detail == null ? null : detailValues.reverse![detail],
      };
}

enum Detail { EMPTY, AK }

final detailValues = EnumValues({"Açık": Detail.AK, "": Detail.EMPTY});
